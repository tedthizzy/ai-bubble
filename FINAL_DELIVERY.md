...
- Automated materiality adjudication decisions: 6,663 decisions, with 4,553
  ...
  metric rows, and $4.709T source-instrument/economic-obligation-deduped final
  metric support across 1,624 metric groups. Semantic hard flags are now zero
  in approved metric rows; 386 approved rows remain indeterminate semantic
  review candidates.
