...
- Markdown: `data/reports/BURRY_REPORT_EvidenceGated_20260602-0237.md`
- JSON: `data/reports/BURRY_REPORT_EvidenceGated_20260602-0237.json`
...
- Automated materiality adjudication decisions: 6,699 decisions, with 4,318
  supported blockers, 2,381 still requiring deeper extraction, 2,733 approved
  metric rows, and $11.872T deduped final metric support.
