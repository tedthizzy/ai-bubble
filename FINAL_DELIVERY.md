...
- Markdown: `data/reports/BURRY_REPORT_EvidenceGated_20260602-1451.md`
- JSON: `data/reports/BURRY_REPORT_EvidenceGated_20260602-1451.json`
...
- Automated materiality adjudication decisions: 6,663 decisions, with 4,468
  supported blockers, 2,195 still requiring deeper extraction, 2,922 approved
  metric rows, and $4.136T deduped final metric support across 1,458
...
- Broader materiality-adjudicated supported exposure: $4.136T across 1,458
...
- Established direct/watchlist AI-data-center-linked support inside that broader
  materiality metric is $0.474T; 89.1% remains source-backed but not yet
  thesis-linked.
