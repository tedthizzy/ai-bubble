...
- Markdown: `data/reports/BURRY_REPORT_EvidenceGated_20260602-0304.md`
- JSON: `data/reports/BURRY_REPORT_EvidenceGated_20260602-0304.json`
...
- Automated materiality adjudication decisions: 6,699 decisions, with 4,330
  supported blockers, 2,369 still requiring deeper extraction, 2,744 approved
  metric rows, and $11.712T deduped final metric support.
