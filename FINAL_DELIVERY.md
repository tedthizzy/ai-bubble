...
- Markdown: `data/reports/BURRY_REPORT_EvidenceGated_20260602-1442.md`
- JSON: `data/reports/BURRY_REPORT_EvidenceGated_20260602-1442.json`
...
- Automated materiality adjudication decisions: 6,663 decisions, with 4,470
  ...
  metric rows, and $4.140T deduped final metric support across 1,459
...
- Broader materiality-adjudicated supported exposure: $4.140T across 1,459
