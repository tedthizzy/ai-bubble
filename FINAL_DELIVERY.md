...
- Markdown: `data/reports/BURRY_REPORT_EvidenceGated_20260602-0404.md`
- JSON: `data/reports/BURRY_REPORT_EvidenceGated_20260602-0404.json`
...
- Automated materiality adjudication decisions: 6,699 decisions, with 4,379
  supported blockers, 2,320 still requiring deeper extraction, 2,793 approved
  metric rows, and $9.270T source-instrument-deduped final metric support
  across 1,936 metric groups.
