...
- Markdown: `data/reports/BURRY_REPORT_EvidenceGated_20260602-1629.md`
- JSON: `data/reports/BURRY_REPORT_EvidenceGated_20260602-1629.json`
...
- Automated materiality adjudication decisions: 6,663 decisions, with 4,324
  supported blockers, 2,339 still requiring deeper extraction, 2,780 approved
  metric rows, and $3.908T deduped final metric support across 1,418
  ...
  availability/capacity/rollup amount mis-bindings now block metric use pending
  source-quote reselection or corrected extraction.
...
- Broader materiality-adjudicated supported exposure: $3.908T across 1,418
...
- Established direct/watchlist AI-data-center-linked support inside that broader
  materiality metric is $0.445T; 89.2% remains source-backed but not yet
  thesis-linked.
