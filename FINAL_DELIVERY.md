...
- Markdown: `data/reports/BURRY_REPORT_EvidenceGated_20260602-0247.md`
- JSON: `data/reports/BURRY_REPORT_EvidenceGated_20260602-0247.json`
...
- Automated materiality adjudication decisions: 6,699 decisions, with 4,322
  supported blockers, 2,377 still requiring deeper extraction, 2,736 approved
