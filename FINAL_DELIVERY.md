...
- Markdown: `data/reports/BURRY_REPORT_EvidenceGated_20260602-1607.md`
- JSON: `data/reports/BURRY_REPORT_EvidenceGated_20260602-1607.json`
...
- Automated materiality adjudication decisions: 6,663 decisions, with 4,352
  supported blockers, 2,311 still requiring deeper extraction, 2,808 approved
  metric rows, and $4.021T deduped final metric support across 1,436
  ...
  availability/capacity mis-bindings now block metric use pending source-quote
  reselection or corrected extraction.
...
- Broader materiality-adjudicated supported exposure: $4.021T across 1,436
