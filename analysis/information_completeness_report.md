...
> September 16 correction: The June statement below that the SpaceX-Google agreement was withdrawn is superseded by SpaceX's [June 5 SEC free-writing prospectus](https://www.sec.gov/Archives/edgar/data/1181412/000162828026041150/spacexagreementfwp.htm), which discloses the agreement and its conditions. The June CoreWeave and SpaceX values below are historical and should be read with the current September filing refresh.
