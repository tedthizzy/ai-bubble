...
> September 16 verification correction: The June entry below missed a separate [June 5 SpaceX SEC free-writing prospectus](https://www.sec.gov/Archives/edgar/data/1181412/000162828026041150/spacexagreementfwp.htm). That primary filing confirms the Google compute agreement for about 110,000 NVIDIA GPUs at $920 million per month from October 2026, subject to delivery and termination terms. The June inference that no primary filing supports the deal is false.
...
## September 16, 2026 corrections and new evidence

These additions preserve the June text. Corrections to information already available in June are separate from later developments. The current synthesis is [here](SYNTHESIS_2026-09-16.md).

- **CoreWeave / Core Scientific acquisition:** The June statement that CoreWeave was acquiring Core Scientific was wrong. Core Scientific announced termination on October 30, 2025 after the shareholder vote. Customer concentration and common ownership are different exposures. [Termination release filed with SEC](https://investors.corescientific.com/sec-filings/all-sec-filings/content/0001140361-25-039808/ef20057995_ex99-1.htm).
- **IREN RPO:** The March 31 10-Q explicitly excludes Microsoft tranches until delivery and acceptance. Low recognized remaining performance obligations alone therefore do not show that the broader contract is cancellable or nonbinding. The June inference and its valuation implication are withdrawn. Contract termination rights require their own evidence. [10-Q, Note 5](https://www.sec.gov/Archives/edgar/data/1878848/000187884826000026/iren-20260331.htm).
- **Nebius backlog omission:** The September 8, 2025 6-K disclosed approximately $17.4B of Microsoft contract value, subject to deployment and availability, with expansion to approximately $19.4B. The June input's statement that the amount was undisclosed is incorrect. Original contract value cannot simply be inserted as September remaining backlog because services have since been delivered. [6-K](https://assets.nebius.com/assets/86625727-9e66-46c1-af79-c27d57434e3c/25-25580-1_Nebius%2520Group%2520N.V._6-K.pdf%3Fcache-buster%3D2025-09-08T21%3A23%3A09.625Z).
- **CoreWeave covenants:** DDTL 3.0's delayed test does not apply to every facility. The August DDTL 5.5 agreement starts its coverage test by January 2027, possibly earlier. Relief on one facility does not establish the reason lenders granted it or current headroom across the company. [August 8-K](https://www.sec.gov/Archives/edgar/data/1769628/000176962826000357/crwv-20260807.htm).
- **Listed BDC exposure:** IREN's August financing names OBDC among lenders and as agent. The older manager-only rationale is incomplete. Funded allocation still needs portfolio-level evidence. Registered S3 membership is retained for historical comparability, with this limitation disclosed. [IREN 10-K](https://www.sec.gov/Archives/edgar/data/1878848/000187884826000052/iren-20260630.htm).
- **Physical overbuild:** Withdrawn or canceled generation projects show proposed supply failing to materialize. They do not establish excess operating data-center capacity. The June synthesis and atlas conflated these concepts. See the current synthesis's construction evidence.
- **GPU economic life:** CoreWeave's reported A100 extension and current rental pricing weaken the blanket two-to-three-year assumption. They do not prove fleet resale recoveries. The historical valuation outputs are preserved with a correction notice; they have not been recalculated.

The newer CoreWeave debt schedule and NVIDIA guarantee disclosures are summarized with primary links in the dated synthesis. The older SpaceX prospectus could not be freshly retrieved: the web tool rejected its size and a direct request returned HTTP 403. Its June transcription is retained as historical evidence, not described as newly verified.
