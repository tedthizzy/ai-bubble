...
- **🔄 In flight / queued:** full 2,091 deep-dive (paced); economy-wide XBRL leverage/coverage scan over **all ~10,365 SEC filers** (breaks the deal-corpus dependency); Form-4/8-K/NT **distress §2.8 extraction**; off-EDGAR sources (UCC/PACER/deeds/customs/NAIC/FERC); the enumerated tail beyond the 2,091 scored (needs acquisition); international.
