...
_GENERIC = {
    "borrower", "borrowers", "guarantor", "guarantors", "lender", "lenders", "the", "company",
    "as", "obligor", "or", "any", "to", "subsidiary", "initial", "resigning", "additional",
    "replacing", "bank", "agent", "and", "existing", "party", "thereto", "newco", "financial",
    "service", "provider", "by", "tenant", "royal", "mezz", "llc", "inc", "lp", "ltd", "plc",
    "corp", "co", "n.a.", "of", "from", "trustee", "swingline",
}
