...
GENERIC_ENTITY_PATTERNS = (
    ...
    re.compile(r"^lenders? from time to time party hereto and\b", re.I),
    re.compile(r"^lenders? party hereto and\b", re.I),
    re.compile(r"^lenders? (parties )?thereto and\b", re.I),
    re.compile(r"^lenders? and\b", re.I),
    re.compile(r"^loan parties party hereto\b", re.I),
    re.compile(r"^guarantors? (from time to time )?party hereto\b", re.I),
    re.compile(r"^lc issuers? party hereto\b", re.I),
    re.compile(r"^issuing lenders? from time to time party hereto\b", re.I),
    re.compile(r"^us and\b", re.I),
    re.compile(r"\bcertain lenders\b", re.I),
    re.compile(r"\btrust indenture act\b", re.I),
    ...
    re.compile(r"\bparty hereto\b", re.I),
    re.compile(r"\bother borrowers\b", re.I),
    re.compile(r"\bparty thereto\b", re.I),
    re.compile(r"\band the guarantor$", re.I),
    re.compile(r"\bto the guarantor\b", re.I),
    re.compile(r"\bthe guarantor \(", re.I),
    re.compile(r"^inter alios\b", re.I),
    re.compile(r"^whereas\b", re.I),
    re.compile(r"\bacts$", re.I),
